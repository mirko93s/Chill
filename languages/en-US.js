exports.commands = {
	...
	report: {
		...
		char: (content) => `${content.slice(0, 1e3)}\n\`${(content.length - 1e3) > 1 ? `characters` : `character`}\``,
	},
	...
	serverinfo: {
		filter_obj: { DISABLED: `Off`, MEMBERS_WITHOUT_ROLES: `No Role`, ALL_MEMBERS: `Everyone`, 0: `Off`, 1: `No Role`, 2: `Everyone` },
