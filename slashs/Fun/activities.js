...
module.exports = {
	...
	run: async (client, interaction, LANG) => {
		...
		if (!interaction.member.voice.channel) return interaction.reply({ ephemeral: true, embeds: [client.chill.error(LANG.not_in_vc)] });
		...
		try {
			...
			return interaction.reply({ ephemeral: true, embeds: [client.chill.error(LANG.error)] });
		}
	},
};