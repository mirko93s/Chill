...
module.exports = {
    ...
    run: async (client, msg, arg) => {
        ...
        if (arg[0] === "list") {
            ...
            if (disabledcommands.length <= 0) return msg.channel.send(nodisabledcmdsEmbed).then(msg => msg.delete({ timeout: 5000 }));
            ...
            return msg.channel.send(disabledEmbed).then(msg => msg.delete({ timeout: 30000 }));
        }
            ...
            if (!arg[1]) return msg.channel.send(noargsEmbed).then(msg => msg.delete({ timeout: 5000 }));
            let command = client.commands.get(arg[1]);
            if (!command) command = client.commands.get(client.aliases.get(arg[1]));
            if (!command) return msg.channel.send(nocmdEmbed).then(msg => msg.delete({ timeout: 5000 }));
            if (!client.settings.includes(msg.guild.id, command.name, "disabledcommands")) {
                ...
                msg.channel.send(disabledEmbed).then(msg => msg.delete({ timeout: 10000 }));
            } else return msg.channel.send(alreadydisabledEmbed).then(msg => msg.delete({ timeout: 5000 }));
        }
            ...
            if (client.settings.includes(msg.guild.id, command.name, "disabledcommands")) {
                ...
                msg.channel.send(enabledEmbed).then(msg => msg.delete({ timeout: 10000 }));
            } else return msg.channel.send(alreadyenabledEmbed).then(msg => msg.delete({ timeout: 5000 }));
        }
        else return msg.channel.send(noargsEmbed).then(msg => msg.delete({ timeout: 5000 }));
