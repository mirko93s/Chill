...
module.exports = {
    ...
    run: async (client, msg, arg) => {
        ...
        if (client.commands.has(command) || client.aliases.has(command)) return msg.channel.send({embeds:[nooverrideEmbed]}).then(msg =>setTimeout(() => msg.delete(), 5000));
        ...
        msg.channel.send({embeds:[ccEmbed]}).then(msg =>setTimeout(() => msg.delete(), 10000));
